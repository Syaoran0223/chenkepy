...
function(a) {
	...
	var b = function(b) {
		...
		d = {
			...
			toolbarCloseText: "完成",
			title: "请选择",
			toolbarTemplate: '<div class="toolbar">          <div class="toolbar-inner">          <a href="javascript:;" class="picker-button close-picker" id="date_select_sure">{{closeText}}</a>          <h1 class="title">{{title}}</h1>          </div>          </div>'
		};
		b = b || {};
